...
#in the column dep_time and dep_delay. Also It is some NA in dep_delay that the original value is 0 because the sched_dep_time is 
#same as dep_time. Also because the time that we have in the weather table was taking 51 minutes after the hour, we will do a 
#new hour column it will have the hour schedule flightif it is lower than 21 of the next hour if it is higher or eaual than 21
#also we will create a column date with the year, day, month and hour in this way will be easir join the tables weather and 
#flights and with that I can drop those columns
flights <- flights %>%
...
#I don't the speed and also it is a column with a lot missing data so I will drop it. The engine electric is relative with drones,
